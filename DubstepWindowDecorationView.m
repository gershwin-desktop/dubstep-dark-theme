...
// Category
/*
@interface DubstepWindowDecorationView (GSTheme) // Originally Dubstep
  - (void) _themeDidActivate: (NSNotification*)notification;
@end
*/

@implementation  DubstepWindowDecorationView
...
//@implementation DubstepWindowDecorationView (GSTheme)
